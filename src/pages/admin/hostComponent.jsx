...
import { Table, Tag, Space, Input, Button, Popconfirm, Modal, Form, Switch, notification } from 'antd';
...
const HostTable = () => {
    ...
    const handleAddHost = async () => {
        try {
            ...
            if (!values === undefined || values.username === undefined
            ...
            if (newHost && newHost.EC === 0) { // Check for the success code from the backend
                ...
                notification.error({
                    ...
                    description: newHost?.message || "An error occurred while adding the host.",
                });
            }
        } catch (error) {
    ...
    return (
        <div>
            <Button type="primary" style={{ marginBottom: 20 }} onClick={() => setIsAddHostModalVisible(true)}>
                Add Host
            </Button>
            <Search
